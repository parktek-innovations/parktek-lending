...
const animateElements = document.querySelectorAll('.feature-card, .testimonial-card, .innovation-card, .component-card');
...
document.querySelectorAll('.feature-card, .testimonial-card, .component-card').forEach(card => {
...
document.addEventListener('DOMContentLoaded', () => {
    console.log('ParkTek website loaded successfully!');
